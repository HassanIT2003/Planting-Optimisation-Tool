...
const html = fs.readFileSync(path.resolve(__dirname, '../recommendations.html'), 'utf-8');
...
describe('Recommendations Page (recommendations.html)', () => {
  ...
  it('should have the correct title', () => {
    expect(document.title).toBe('Agroforestry Recommendations | Planting Optimisation Tool');
  });
